...
import cassandra.tests.repositories.HistoryAIQuarterRepository;
import cassandra.tests.util.AppContextLoader;

public class HistoryAIQuarterRepositorySelectByIdAndTsRangeTest {
	int count = 0;
	...
	public void setUp() {
		...
		repository = ctxLoader.getContext().getBean(HistoryAIQuarterRepository.class);
	...
	private HistoryAIQuarterRepository repository;
