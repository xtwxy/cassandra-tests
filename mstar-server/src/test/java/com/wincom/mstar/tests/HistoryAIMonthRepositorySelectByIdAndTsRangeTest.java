...
public class HistoryAIMonthRepositorySelectByIdAndTsRangeTest {
	int count = 0;
	...
	public void setUp() {
		...
		repository = ctxLoader.getContext().getBean(HistoryAIMonthRepository.class);
		
		Insert insert = QueryBuilder.insertInto("history_ai_month")
		.value("id", 1)
	...
	private HistoryAIMonthRepository repository;
