...
create table history_ai_month(id int, ts bigint, value double, primary key(id, ts));
create table history_ai_year(id int, ts bigint, value double, primary key(id, ts));
